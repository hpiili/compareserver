...
sub connectDBTC {
	# ##################### CONNECTIONS #####################
	my $tc_dsn;
	$tc_dsn = "DBI:Proxy:hostname=tcdbproxy;port=9002;dsn=jdbc:sqlserver://$ENV{'tcdbhost'}:$ENV{'tcdbport'};databaseName=$ENV{'tcdatabase'}";
...
sub connectDBWDMS {
	# ##################### CONNECTIONS #####################
	my $dsn = "DBI:Proxy:hostname=wdmsdbproxy;port=9001;dsn=jdbc:oracle:thin:\@$ENV{'wdmsdbhost'}:$ENV{'wdmsdbport'}:$ENV{'wdmsdatabase'}";
